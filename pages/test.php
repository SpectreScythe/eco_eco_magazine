...
<div class="nav">
    ...
    <ul>
        <a target="_blank" href="add/add_article_page.php">
...
<div class="main">
    ...
    if (!$connection) {
        ...
        $getImages = 'SELECT * FROM img_test';
        ...
        if (mysqli_num_rows($result)) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<img class="testImg" src="data:image;base64,' . base64_encode($img) . '" alt="IMAGE">';
            }
        }
    }
