...
<div class="article-container">
    ...
    $getImages = 'SELECT * FROM eco_eco_article WHERE article_type = "minions"';
    ...
    if (mysqli_num_rows($result)) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<img class="my-img full_img" src="data:image;base64,' . base64_encode($deadpool_main) . '" alt="IMAGE">';
    ...
    ?>
    <img class="full_img" src="../../images/minions/minionsC.png" alt="">
</div>
