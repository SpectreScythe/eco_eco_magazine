...
<div class="nav">
    <ul>
        ...
        <a target="_blank" href="../fashion.php">
        ...
        <a target="_blank" href="../entertainment.php">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
        ...
        <a target="_blank" href="../games.php">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
    ...
    <ul>
        <a target="_blank" href="../auth/login_page.php">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
...
<div class="article-container">
    ...
    $getImages = 'SELECT * FROM eco_eco_article WHERE article_type = "walter"';
    ...
    <p class="short-para">As acclaimed as Breaking Bad was, it is always risky to continue a story after giving
        ...
        spinoffs. Part of that reason was the creators understanding what audiences wanted to see more of while also
        determining what they didn't need to see more of.</p>
</div>
